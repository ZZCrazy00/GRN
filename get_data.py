...
train_neg = neg_data.sample(n=len(train_pos), random_state=42)
val_neg = neg_data.sample(n=len(val_pos), random_state=42)
test_neg = neg_data.sample(n=len(test_pos), random_state=42)
train_neg['label'] = 0
val_neg['label'] = 0
test_neg['label'] = 0
